...
def inception_v3_avg_scope(weight_decay=0.00004, stddev=0.1, batch_norm_var_collection='moving_vars'):
    ...
    # automatic assignment of function parameters
...
# convolutional layers of inceptionnet-v3
def inception_v3_base(inputs, scope=None):
    end_points = {}
    # convolutional layers before inception module
